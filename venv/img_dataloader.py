...
class ImageDataset(Dataset):
    ...
    def __init__(self, transform=transforms.ToTensor(), color='L'):
        ...
        self.image_info = pd.read_csv("/home/zeppelin/PycharmProjects/math179final/101_ObjectCategories/image_labels.csv")
        self.image_filenames = self.image_info["names"]
