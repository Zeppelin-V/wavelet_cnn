...
class baselineCNN(nn.Module):
    ...
    def __init__(self):
        ...
        self.convk0 = nn.Conv2d(in_channels=1, out_channels=4, kernel_size=2, stride=2)
        self.convk0_normed = nn.BatchNorm2d(4)
        torch_init.xavier_normal_(self.convk0.weight)
    ...
    def forward(self, batch):
        ...
        #Compute first replacement convolution
        cvk0_batch = func.relu(self.convk0_normed(self.convk0(batch)))

        # Apply the k1 convolution layers
        cvk1a_batch = func.relu(self.convk1a_normed(self.convk1a(cvk0_batch)))
        cvk1b_batch = func.relu(self.convk1b_normed(self.convk1b(cvk1a_batch)))
        ...
        # Apply the s1.5 skip connection
        cvs15_batch = func.relu(self.convs15_normed(self.convs15(cvk00_batch)))
